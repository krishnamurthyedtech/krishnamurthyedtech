        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Card className="relative overflow-hidden flex flex-col p-6 md:p-8 border-white/10 bg-[#080808] transition-all duration-500 group hover:shadow-[0_0_40px_8px_rgba(139,92,246,0.25)] hover:border-purple-500 hover:bg-[#1a102c]">
             ...
             <div className="flex justify-between items-start mb-8">
                ...
                <div className="w-14 h-14 bg-purple-500/10 rounded-2xl flex items-center justify-center text-purple-500 border border-purple-500/20 shadow-[0_0_20px_rgba(139,92,246,0.15)]">

                   <Sparkles size={28} />

                </div>

                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-purple-500/50">Ecosystem</span>
             ...
             <div className="pointer-events-none absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{ boxShadow: '0 0 80px 20px rgba(139,92,246,0.25)' }}></div>
